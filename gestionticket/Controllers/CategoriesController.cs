...
namespace gestionticket.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(gestionticketContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categorie != null ? 
                          ...
                          Problem("Entity set 'gestionticketContext.Categorie'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'gestionticketContext.Categorie'  is null.");
            }
            var categorie = await _context.Categorie.FindAsync(id);
            if (categorie != null)
            {
